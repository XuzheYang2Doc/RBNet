...
The file  <strong>analyze_annotations.py <strong> is used for visual analysis of annotations.
The file  <strong>human_compare <strong> is used for comparing the assesment results between hunman and RBNet.
