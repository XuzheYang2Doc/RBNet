...
- `analyze_annotations.py` is used for visual analysis of annotations.
- `human_compare.py` is used for comparing the assessment results between humans and RBNet.
