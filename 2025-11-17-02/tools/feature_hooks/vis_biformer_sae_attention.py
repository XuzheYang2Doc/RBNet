...
Outputs one PNG per attention source under 2025-11-17-02/results by default.
...
def main() -> None:
    ...
    parser.add_argument('--out-dir', default='results', help='Output directory (relative to 2025-11-17-02)')
