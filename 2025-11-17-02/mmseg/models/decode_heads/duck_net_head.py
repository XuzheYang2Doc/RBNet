...
class DuckNet(BaseDecodeHead):
    def __init__(self, in_channels, out_channels=64, depth=5, init_features=32, normalization='batch',
                 interpolation='nearest', out_activation='sigmoid', use_multiplier=False, **kwargs):
        ...
        """
        super(DuckNet, self).__init__(**kwargs)
