...
class ParaTransCNN(BaseDecodeHead):
    def __init__(self, n_channels=3, heads=4, dim=160, depth=(3, 3, 3), patch_size=2, **kwargs):
        super(ParaTransCNN, self).__init__(**kwargs)
        ...
        self.out = nn.Conv2d(dim, 64, kernel_size=1)
