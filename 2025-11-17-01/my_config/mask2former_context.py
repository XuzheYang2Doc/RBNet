...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/train40.json',
        data_prefix=dict(img='train40/', seg='annotations/panoptic_train2017/'),
...
log_level = 'INFO'
load_from = "/data/code2025/Q2/2025-11-17-01/work_dirs_temp/mask2former_context/iter_10000.pth"
resume = False
launcher = 'pytorch'
