...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--checkpoint', type=str, default="/data/code2025/Q2/2025-11-17-01/work_dirs/mask2former/iter_5000.pth", help='Checkpoint file path')
    parser.add_argument(
        '--input-dir', type=str, default="/data/code2025/Q2/2025-11-17-02/datasets/test/images", help='Directory with images')
    parser.add_argument(
        '--output-dir',
        type=str,
        default="/data/code2025/Q2/2025-11-17-02/datasets/test/pred",
