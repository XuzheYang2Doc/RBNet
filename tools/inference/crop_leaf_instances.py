...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--checkpoint', type=str, default="checkpoints/mask2former_leaf.pth", help='Checkpoint file path')
    parser.add_argument(
        '--input-dir', type=str, default="data/instance/images", help='Directory with images')
    parser.add_argument(
        '--output-dir',
        type=str,
        default="outputs/leaf_crops/images",
        help='Directory to store cropped results')
    parser.add_argument(
        '--label-output-dir',
        type=str,
        default="outputs/leaf_crops/labels",
        help='Directory to store semantic segmentation labels')
    parser.add_argument(
        '--annotation-file',
        type=str,
        default="data/instance/annotations/instances_test.json",
